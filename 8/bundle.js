...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: DEFAULT_POINT, SORT_TYPE */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const DEFAULT_POINT = {
  ...
  type: _mock_point_js__WEBPACK_IMPORTED_MODULE_2__["pointTypes"][0],
  city: _mock_point_js__WEBPACK_IMPORTED_MODULE_2__["citiesList"][0],
  timeStart: dayjs__WEBPACK_IMPORTED_MODULE_0___default()().format(`DD/MM/YY HH:mm`),
  timeEnd: dayjs__WEBPACK_IMPORTED_MODULE_0___default()().format(`DD/MM/YY HH:mm`),
  price: ``,
  offers: ``,
  destination: ``
};
...
/*!***************************!*\
  !*** ./src/mock/point.js ***!
  \***************************/
/*! exports provided: pointTypes, citiesList, offersList, generatePoint */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class Trip {
  constructor(tripContainer, pointsContainer) {
    ...
    this._currentSortType = _const_js__WEBPACK_IMPORTED_MODULE_17__["SORT_TYPE"].DAY;
  ...
  _handlePointChange(updatedPoint) {
    this._points = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["updatedItem"])(this._points, updatedPoint);
  ...
  _sortPoints(sortType) {
    switch (sortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_17__["SORT_TYPE"].DAY:
        this._points.sort(_utils_sort_js__WEBPACK_IMPORTED_MODULE_1__["pointsSortDate"]);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_17__["SORT_TYPE"].TIME:
        this._points.sort(_utils_sort_js__WEBPACK_IMPORTED_MODULE_1__["pointsSortDuration"]);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_17__["SORT_TYPE"].PRICE:
  ...
  _renderHeaderInfo() {
    this._headerInfo = new _view_header_info_js__WEBPACK_IMPORTED_MODULE_4__["default"](this._points);
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomInteger, getRandomItem, updatedItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const pointsSortDate = (a, b) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()(a.date).diff(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(b.date));
...
/* harmony import */ var _mock_point_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../mock/point.js */ "./src/mock/point.js");
/* harmony import */ var _view_abstract_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/abstract.js */ "./src/view/abstract.js");
...
const createAddPointForm = (point = {}) => {
  ...
  const citiesTemplate = createPointCitiesTemplate(_mock_point_js__WEBPACK_IMPORTED_MODULE_2__["citiesList"]);
  const dateTemplate = createPointDateTemplate(timeStart, timeEnd);
  const offersTemplate = createPointOffersTemplate(_mock_point_js__WEBPACK_IMPORTED_MODULE_2__["offersList"], offers);
      ...
      <div class="event__type-wrapper">
        ...
        <div class="event__type-list">
          <fieldset class="event__type-group">
            ...
            ${createPointTypesTemplate(type, _mock_point_js__WEBPACK_IMPORTED_MODULE_2__["pointTypes"])}
          </fieldset>
        </div>
      </div>
...
class AddPointForm extends _view_abstract_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
  constructor(point = _const_js__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_POINT"]) {
    super();
...
/* harmony import */ var _view_smart_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/smart.js */ "./src/view/smart.js");
...
const createEditPointForm = (data) => {
  ...
  const citiesTemplate = createPointCitiesTemplate(_mock_point_js__WEBPACK_IMPORTED_MODULE_3__["citiesList"]);
  const dateTemplate = createPointDateTemplate(timeStart, timeEnd);
  const offersTemplate = createPointOffersTemplate(_mock_point_js__WEBPACK_IMPORTED_MODULE_3__["offersList"], offers);
  const descriptionTemplate = createPointDescriptionTemplate(description);
  const photosTemplate = createPointPhotosTemplate(photos);
    ...
    <header class="event__header">
      <div class="event__type-wrapper">
        ...
        <div class="event__type-list">
          <fieldset class="event__type-group">
            <legend class="visually-hidden">Event type</legend>
            ${createPointTypesTemplate(type, _mock_point_js__WEBPACK_IMPORTED_MODULE_3__["pointTypes"])}
          </fieldset>
        </div>
      </div>
...
class EditPointForm extends _view_smart_js__WEBPACK_IMPORTED_MODULE_4__["default"] {
  constructor(point) {
    super();
    ...
    this._timeStartPicker = flatpickr__WEBPACK_IMPORTED_MODULE_1___default()(this.getElement().querySelector(`#event-start-time-1`),
        {
          ...
          defaultDate: dayjs__WEBPACK_IMPORTED_MODULE_0___default()(this._data.timeStart).toDate(),
          enableTime: true,
  ...
  _setTimeEndPicker() {
    ...
    this._timeEndPicker = flatpickr__WEBPACK_IMPORTED_MODULE_1___default()(this.getElement().querySelector(`#event-end-time-1`),
        {
          dateFormat: `d/m/Y H:i`,
          defaultDate: dayjs__WEBPACK_IMPORTED_MODULE_0___default()(this._data.timeEnd).toDate(),
          enableTime: true,
          minDate: new Date(),
  ...
  _timeStartChangeHandler([userDate]) {
    this.updateData({
      timeStart: dayjs__WEBPACK_IMPORTED_MODULE_0___default()(userDate).second(59).toDate(),
    }, true
    );
  }
  ...
  _timeEndChangeHandler([userDate]) {
    this.updateData({
      timeEnd: dayjs__WEBPACK_IMPORTED_MODULE_0___default()(userDate).second(59).toDate(),
    }, true
    );
  }
  _priceInputHandler(evt) {
...
const createEventsSortForm = () => {
  ...
  <div class="trip-sort__item  trip-sort__item--day">
    <input id="sort-day" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SORT_TYPE"].DAY}" checked>
    <label class="trip-sort__btn" for="sort-day">Day</label>
  </div>

  <div class="trip-sort__item  trip-sort__item--event">
    <input id="sort-event" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SORT_TYPE"].EVENT}" disabled>
  ...
  <div class="trip-sort__item  trip-sort__item--price">
    <input id="sort-price" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SORT_TYPE"].PRICE}">
    <label class="trip-sort__btn" for="sort-price">Price</label>
  </div>

  <div class="trip-sort__item  trip-sort__item--offer">
    <input id="sort-offer" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SORT_TYPE"].OFFER}" disabled>
...
const createInfo = (points) => {
  let cities = _mock_point_js__WEBPACK_IMPORTED_MODULE_1__["citiesList"].reduce((total, current) => total + ` &mdash; ` + current);
  if (_mock_point_js__WEBPACK_IMPORTED_MODULE_1__["citiesList"].length > 3) {
    cities = _mock_point_js__WEBPACK_IMPORTED_MODULE_1__["citiesList"][0] + ` &mdash; ... &mdash; ` + _mock_point_js__WEBPACK_IMPORTED_MODULE_1__["citiesList"][_mock_point_js__WEBPACK_IMPORTED_MODULE_1__["citiesList"].length - 1];
  }
  points.sort(_utils_sort_js__WEBPACK_IMPORTED_MODULE_2__["pointsSortDate"]);
  return `<div class="trip-info__main">
  <h1 class="trip-info__title">${cities}</h1>
  <p class="trip-info__dates">${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(points[0].date).format(`MMM DD`)}&nbsp;&mdash;&nbsp;${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(points[points.length - 1].date).format(`DD`)}</p>
  </div>`;
};

class HeaderInfo extends _view_abstract_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
  constructor(points) {
    super();
    this._points = points;
  }
